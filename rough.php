...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="200">
    ...
    <div class="site-section bg-light" id="section-contact">
        ...
        class="btn btn-primary py-2 px-4 text-white w-100"
        style="background-color: dark-orange; border: none; border-radius: 0;">
    Update
</button>
...
function updatePrice() {
    ...
    if (weight && send_location !== "Please Select" && end_location !== "Please Select") {
        $.ajax({
        ...
        alert("⚠️ Please enter weight and select both locations!");
    }
}
</script>
